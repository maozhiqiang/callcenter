...
from YouPBX.xadmin.utils import fa_icon
from YouPBX.xadmin.views.dashwidget import HtmlWidget, widget_manager
from YouPBX.xadmin import site
from YouPBX.xadmin.views.website import IndexView
from YouPBX.apps.base import models
...
class PbxStatusWidget(HtmlWidget):
    ...
    def context(self, context):
        from YouPBX.pbx.rpc import in_api
        res = in_api.status()
        if res['code']==0:
