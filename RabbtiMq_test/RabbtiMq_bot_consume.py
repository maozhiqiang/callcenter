...
LOGGER = logging.getLogger('fs_call')
...
class DBConsumer(object):
    ...
    def setup_exchange(self, exchange_name):
        ...
        self._channel.exchange_declare(self.on_exchange_declareok,
                                       exchange_name,
                                       self.EXCHANGE_TYPE,self.durable)
...
def db_writer(dct):
    ...
    if dct.has_key('mark') and   dct['mark'] == 'insert':
        ...
        runsql(sql)
    elif dct.has_key('mark') and dct['mark'] == 'update':
...
def main():
    consumer = DBConsumer('amqp://call_user:123456@127.0.0.1:5672/call?heartbeat_interval=30')  # %2F=/ needed
    try:
        consumer.run()
